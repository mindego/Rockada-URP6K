...
//    public class CRC32
//    {
//        public const UInt32 CRC_NULL = 0xFFFFFFFF;
//        private DamienG.Security.Cryptography.Crc32 crc32;
//        public CRC32()
//        {
//            crc32 = new DamienG.Security.Cryptography.Crc32();
//        }

//        public UInt32 HashString(string s)
//        {
//            if (s == null ) return CRC_NULL;
//            if (s == String.Empty) return CRC_NULL;
...
//            Array.Reverse(hash);
//            var code = BitConverter.ToInt32(hash);
